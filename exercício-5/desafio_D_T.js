// Exercício 5_D: Desafio Integrador - E-commerce - Thalyta Ferreira
...
const verificaEstoque = inventory.some(product => product.stock === 0);

if (verificaEstoque) {
    console.log("Existem produtos sem estoque no inventário.");
} 
else
    console.log("Não existem produtos sem estoque no inventário.");