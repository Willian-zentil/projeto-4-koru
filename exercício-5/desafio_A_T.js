// Exercício 5-A: Desafio Integrador - E-commerce - Thalyta Ferreira
...
inventory.forEach(produto => {
    ...
    console.log(`Preço: R$ ${produto.price.toFixed(2)}`); // Formata o preço para 2 casas decimais
    console.log(`Estoque: ${produto.stock}`);
    console.log(`Categoria: ${produto.category}`);
    console.log(`Avaliações: [${produto.reviews.join(', ')}]`); // Exibe as avaliações separadas por vírgula
    console.log("-----------------------");
});